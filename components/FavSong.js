...
const FavSong = () => {
    ...
    return (
        <div className="">
            <div className="flex w-full justify-end">
                <div className="p-10">
                    <button onClick={() => setIsOpen(true)}  data-tip="Hello!" data-tooltip-id="my-tooltip" data-tooltip-content="Favorite Songs">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-heart stroke-pink-500 fill-pink-500"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>
                    </button>
                </div>
            </div>
            <Tooltip
            ...
            {isOpen && <div className="bg-[rgba(0,0,0,0.2)] absolute z-10 top-0 left-0 bottom-0 w-full h-full backdrop-blur invert-0">
