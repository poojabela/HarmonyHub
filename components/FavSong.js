                                ...
                                <div key={fav?.id} className="flex w-[min(500px,_100%)] justify-between items-center py-3">
                                    ...
                                    <div className="buttons flex gap-2">
                                        <button onClick={() => isPlaying && currentSong === fav ? handlePause() : handlePlay(fav)}>
                                            {isPlaying && currentSong === fav ?  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-pause stroke-green-500"><rect x="6" y="4" width="4" height="16"></rect><rect x="14" y="4" width="4" height="16"></rect></svg> : <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-play stroke-green-500"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg>}
                                        </button>
